...
--
-- Name: aggiorna_totale_scontrino(); Type: FUNCTION; Schema: Kalunga; Owner: -
--

CREATE FUNCTION "Kalunga".aggiorna_totale_scontrino() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: applica_sconto_scontrino(integer, boolean); Type: FUNCTION; Schema: Kalunga; Owner: -
--

CREATE FUNCTION "Kalunga".applica_sconto_scontrino(scontrino_id integer, usa_punti boolean) RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
    tessera_id INT;
...
DECLARE
    ...
    prezzo_unitario NUMERIC(10,2);
BEGIN
    -- check negozio non eliminato
    IF EXISTS (
        SELECT 1 FROM negozio WHERE id = NEW.negozio AND eliminato = TRUE
    ) THEN
...
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT12345678901', 2, 5.00, 80);
...
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT98765432109', 2, 5.10, 70);
...
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT88899900011', 5, 0.32, 190);
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT11122233344', 6, 1.75, 60);
...
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT44455566677', 13, 0.64, 150);
...
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT12345678901', 16, 0.92, 100);
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT12345678901', 17, 0.68, 110);
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT12345678901', 19, 1.85, 130);
INSERT INTO "Kalunga".fornitore_prodotto VALUES ('IT12345678901', 20, 1.15, 140);
...
SELECT pg_catalog.setval('"Kalunga".approvvigionamento_id_seq', 3, true);
...
SELECT pg_catalog.setval('"Kalunga".negozio_id_seq', 14, true);
...
--
-- Name: scontrino_prodotto trigger_aggiorna_totale_scontrino; Type: TRIGGER; Schema: Kalunga; Owner: -
--

CREATE TRIGGER trigger_aggiorna_totale_scontrino AFTER INSERT OR DELETE OR UPDATE ON "Kalunga".scontrino_prodotto FOR EACH ROW EXECUTE FUNCTION "Kalunga".aggiorna_totale_scontrino();
